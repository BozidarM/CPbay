    ...
    <div id="main">
        <div class="column">
            <div id="filter-bar">
               ...
               <?php 
                $sql = "SELECT COUNT(products.product_id) AS 'number_of_products' FROM products WHERE products.name LIKE '%".$q."%' OR description LIKE '%".$q."%'";
                $rez = $conn->query($sql);  
           ...
           <?php
               $sql = "SELECT 
                       ...
                       FROM
                          ...
                          sellers
                       WHERE
                          sellers.seller_id = products.seller_id AND (products.name LIKE '%".$q."%' OR description LIKE '%".$q."%')
                       GROUP BY
                          products.product_id";
                $rez = $conn->query($sql);  
               ...
               while($red=$rez->fetch_assoc()){ 
                  ...
                  echo "<input type='number' id='quantity' name='quantity' placeholder='Kolicina...' min='1'>";
